...
variables that **Avg_Open_To_Buy** is highly correlated with
**Credit_Limit**, so we will remove **Avg_Open_To_Buy** because it is
redundant to keep both of these variables. We can see that
...
variables with the highest correlation are **Total_Trans_Amt**,
**Exited**, **Total_Relationship_Count**, and **Contacts_Count_12_mon**.

Now we will explore the **Total_Trans_Ct variable** and its relationship
with other correlated variables in our data.

Figure 2 ![](Analysis_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
Figure 3 ![](Analysis_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->

In figure 3, for all of the income categories, we see a bimodal
distribution for the **Total_Trans_Ct**. For people in the income
...
Figure 4 ![](Analysis_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
Figure 5 ![](Analysis_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
Figure 6 ![](Analysis_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
Figure 8 ![](Analysis_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
Figure 9 ![](Analysis_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
Figure 10 ![](Analysis_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
Figure 11 ![](Analysis_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
Figure 12 ![](Analysis_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
Figure 13 ![](Analysis_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
Figure 14 ![](Analysis_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->

**Equal Error Variance**

Figure 15 ![](Analysis_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
Figure 19 ![](Analysis_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
...
in transaction count, as the R-squared value is 0.8281. Therefore, 82.8%
of the variation in the total transaction count transformed variable is
explained by the model. The root mean square error of the model is
1.977, which is the typical deviation of the actual Y value from the
predicted Y value.
...
From Table 1.17 customers with transaction amounts of \$6000, we are 95%
confident that the true mean transaction count to the power of 0.7 is
between 21.88 and 22.004.
...
Figure 20 ![](Analysis_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
the Lack of Fit Test, and a small p value of \<0.0001.
...
In Table 2.10 a p value of \<0.0001 for the model utility test, we
reject the null hypothesis and conclude that our model is significant.
...
same combination of attributes, we are 95% confident that the customer’s
total transaction count will be between 65.42 and 100.74 transactions,
which is a much larger range than the confidence interval. This choice
of explanatory variables is of interest because there are many customers
with this combination of attributes, and we would like to see the
intervals for customers who spend more than most customers, which is why
we choose a transaction count of \$6,000.

**Possible Extra: Richer Model and Interpretation**

Figure 29 ![](Analysis_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
Figure 30 ![](Analysis_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
Figure 31 ![](Analysis_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
percentile for the customers that exited is below the 25% percentile for
the customers that did not exit, which demonstrates that transaction
count does a very good job at discriminating between if a customer exits
or not.

Figure 32 ![](Analysis_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
Figure 34 ![](Analysis_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->
...
The computer’s odds factor is 0.9474 in Table 3.2, with a 95% confidence
interval of 0.943 to 0.9509. We are 95% confident that the true decrease
in odds of exiting the company for an increase of 1 in total transaction
count is between 0.943 and 0.9509 times.
...
\<0.001 in the whole model test, we can conclude that the model is a
significant model in terms of whether or not a customer will exit based
on total translation amount, total relationship count, and gender.
...
Figure 38 ![Alt
text](https://github.com/hasiegler/STATProject/blob/main/LR9.png?raw=true)
